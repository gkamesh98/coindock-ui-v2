...
import WalletName, { walletnameValidation } from "Shared/Form/WalletFields/WalletName";
  ...
  const handleChanges = (e) => {
    ...
    setformValues((formValues) => {
      setformErrors((errors) => ({
        ...errors,
        [name]: handleValidation({ ...formValues, [name]: value }).errors[name],
      }));
      ...
      <form onSubmit={handleSubmit} onInput={handleChanges}>
        ...
        >
          <div className="d-flex justify-content-between">
            <h4>Wallet</h4>
            <RiCloseLine size="30px" cursor="pointer" onClick={() => handleSetTrigger(false)} />
          </div>
