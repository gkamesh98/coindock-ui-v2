              ...
              <div className="row">
                <div className="col-md-2">
                  <div className="photo-box">
                    <h6>
                      <img src={value?.logo} className="cd_coin_logo" alt={value.coin_name} />
                    </h6>
                  </div>
                </div>
                <div className="col-md-2">
                ...
                <div className="col-md-2">
                  <div className="photo-box">
                    <h6 className="text-end">{value?.primary_currency.toFixed(2)}</h6>
                    <p className="mb-2 text-muted text-end">{value?.primary_currency_code}</p>
                  </div>
                </div>
                <div className="col-md-2">
                  <div className="photo-box">
                    <h6 className="text-end">{value?.secondary_currency}</h6>
                    <p className="mb-2 text-muted text-end">{value?.secondary_currency_code}</p>
                  </div>
                </div>
              </div>
            </div>
