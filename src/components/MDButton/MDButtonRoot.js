...
export default styled(Button)(({ theme, ownerState }) => {
  ...
  const { colored } = boxShadows; // styles for the button with variant="contained"
  const containedStyles = () => {
    ...
    const boxShadowValue = colored[color]
      ...
      : "none"; // boxShadow value when button is hovered
  ...
  const outliedStyles = () => {
    ...
    const boxShadowValue = palette[color]
      ? boxShadow([0, 0], [0, 3.2], palette[color].main, 0.5)
      : boxShadow([0, 0], [0, 3.2], white.main, 0.5); // border color value
  ...
  const gradientStyles = () => {
    ...
    const backgroundValue =
      color === "white" || !gradients[color]
        ? white.main
        : linearGradient(gradients[color].main, gradients[color].state); // boxShadow value
    const boxShadowValue = colored[color]
      ? `${boxShadow([0, 3], [3, 0], palette[color].main, 0.15)}, ${boxShadow(
          [0, 3],
          [1, -2],
