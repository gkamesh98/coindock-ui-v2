...
import MDTypography from "components/MDTypography"; // Material Dashboard 2 React base styles
...
function ProfileInfoCard({ title, description, info, social, action, shadow }) {
  ...
  const { size } = typography; // Convert this form `objectKey` of the object key in to this `object key`
